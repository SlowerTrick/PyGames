...
class Game:
    ...
    def import_assets(self):
        ...
        self.audio_files = {
            ...
            'run': pygame.mixer.Sound(join('..', 'audio', 'run.wav')),
            ...
            'lace_teleport_in': pygame.mixer.Sound(join('..', 'audio', 'lace_teleport_in.wav')),
            'lace_teleport_out': pygame.mixer.Sound(join('..', 'audio', 'lace_teleport_out.wav')),
            ...
            'spike_hit': pygame.mixer.Sound(join('..', 'audio', 'spike_hit.wav')),
